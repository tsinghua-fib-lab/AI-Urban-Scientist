# Data.gov Catalog SourceSkill

## Purpose

Emit not-final source-prior hints for U.S. federal open-data catalog leads; resource files still need source-specific validation.

## When To Use

Use when the need asks for government data/catalog and this source family is a plausible publisher, catalog, repository, or provider.
...
- `scripts/find_data_gov_catalog.py` emits not-final source-card route hints.
