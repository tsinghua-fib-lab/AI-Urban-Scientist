# NASA Earthdata CMR SourceSkill

## Purpose

Emit not-final source-prior hints for NASA Earthdata CMR collection/granule search leads for Earth observation products.

## When To Use

Use when the need asks for remote sensing/climate and this source family is a plausible publisher, catalog, repository, or provider.
...
- `scripts/find_nasa_earthdata_cmr.py` emits not-final source-card route hints.
