# Microsoft Global ML Building Footprints SourceSkill

## Purpose

Emit not-final source-prior hints for Microsoft global ML building-footprint file-index leads.

## When To Use

Use when the need asks for buildings/geospatial and this source family is a plausible publisher, catalog, repository, or provider.
...
- `scripts/find_microsoft_building_footprints.py` emits not-final source-card route hints.
This uses source-specific or metadata-page mechanics, not a generic platform tool.
