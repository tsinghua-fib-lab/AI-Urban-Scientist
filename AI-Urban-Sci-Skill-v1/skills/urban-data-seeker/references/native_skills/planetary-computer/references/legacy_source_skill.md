# Microsoft Planetary Computer SourceSkill

## Purpose

Emit not-final source-prior hints for Planetary Computer STAC collection, item, and asset leads.

## When To Use

Use when the need asks for remote sensing/cloud geospatial and this source family is a plausible publisher, catalog, repository, or provider.
...
- `scripts/find_planetary_computer.py` emits not-final source-card route hints.
Platform mechanics may be delegated to: `stac_platform`.
