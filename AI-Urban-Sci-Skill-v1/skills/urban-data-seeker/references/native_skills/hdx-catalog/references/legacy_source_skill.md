# Humanitarian Data Exchange SourceSkill

## Purpose

Emit not-final source-prior hints for HDX humanitarian catalog and HAPI leads for crisis, population, boundary, and response data.

## When To Use

Use when the need asks for humanitarian/risk/population and this source family is a plausible publisher, catalog, repository, or provider.
...
- `scripts/find_hdx_catalog.py` emits not-final source-card route hints.
Platform mechanics may be delegated to: `ckan_platform`.
